...
struct DeviceTestServiceCommand_HandleDevCfgUpdate
{
  uint16 size;
};
...
struct DeviceTestServiceCommand_HandleDevCfgUpdatePart
{
  struct sequence value;
};
...
struct DeviceTestServiceCommand_HandleDevCfgReadPart
{
  uint16 size;
};
...
void DeviceTestServiceCommand_HandleDevCfgUpdate(Task , const struct DeviceTestServiceCommand_HandleDevCfgUpdate *);
...
void DeviceTestServiceCommand_HandleDevCfgRead(Task );
...
void DeviceTestServiceCommand_HandleDevCfgUpdatePart(Task , const struct DeviceTestServiceCommand_HandleDevCfgUpdatePart *);
...
void DeviceTestServiceCommand_HandleDevCfgReadPart(Task , const struct DeviceTestServiceCommand_HandleDevCfgReadPart *);
